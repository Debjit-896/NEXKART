      ...
      <div className="w-full px-4 md:px-10 lg:px-16 xl:px-24 mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-8 md:mb-6">
        ...
        <div className="flex flex-col gap-5 md:gap-4">
          <Link to="/" className="inline-block mb-1 -ml-2">
            <img src="/logo.png" alt="NextKart Logo" className="w-[150px] md:w-[170px] max-w-none mix-blend-multiply" />
          </Link>
          ...
          <div className="space-y-2 mt-2">
            ...
            <div className="flex gap-2">
              <a href="#" className="bg-black hover:bg-gray-800 transition-colors rounded-md px-2 py-1.5 flex items-center gap-1.5">
                <Apple size={20} className="text-white" />
                <div className="flex flex-col">
                  <span className="text-[8px] uppercase leading-none opacity-80">Download on the</span>
              ...
              <a href="#" className="bg-black hover:bg-gray-800 transition-colors rounded-md px-2 py-1.5 flex items-center gap-1.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[8px] uppercase leading-none opacity-80">GET IT ON</span>
        ...
        <div className="relative">
          <h3 className="font-medium text-base mb-4 border-b border-white/20 pb-1 inline-block">Most Popular Categories</h3>
          <ul className="space-y-2 flex flex-col items-start relative z-10">
            {['Staples', 'Beverages', 'Personal Care', 'Home Care', 'Baby Care', 'Vegetables & Fruits', 'Snacks & Foods', 'Dairy & Bakery'].map((item) => (
              <li key={item} className="flex items-center gap-2 text-xs opacity-90 hover:opacity-100 hover:translate-x-1 transition-all cursor-pointer">
        ...
        <div className="relative">
          <h3 className="font-medium text-base mb-4 border-b border-white/20 pb-1 inline-block">Customer Services</h3>
          <ul className="space-y-2 flex flex-col items-start relative z-10">
