      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl flex flex-col md:flex-row overflow-hidden border border-gray-100">
        ...
        <div className="w-full md:w-1/2 bg-[#0A88FF] p-8 flex flex-col relative overflow-hidden min-h-[320px]">
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-xs max-w-xs mt-3">
              Simplify your e-commerce experience with our user-friendly
              shopping dashboard.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center bg-white">
          ...
          <div className="flex flex-col items-center text-center mb-5">
            <Link
              to="/"
              className="flex items-center justify-center overflow-hidden h-10 w-[120px] mb-3"
            >
              <img
                src="/logo.png"
                alt="NextKart"
                className="w-[120px] max-w-none mix-blend-multiply"
              />
            </Link>
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="flex justify-end">
              <Link
                to="/forgot-password"
                className="text-xs font-medium text-gray-500 hover:text-primary-blue transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-[#0A88FF] hover:bg-[#339DFF] disabled:bg-gray-400 text-white font-semibold rounded-xl transition-colors shadow-md text-sm"
            >
              Login
            </button>
          </form>
