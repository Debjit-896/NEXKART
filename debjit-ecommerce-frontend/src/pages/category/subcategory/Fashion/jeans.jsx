...
export default function JeansPage() {
  ...
  const subcategoryDisplayName = 'Jeans';
  
  const currentConfig = filterConfig['fashion'].subcategories['jeans'];
  ...
  // Mock Products
  const products = [
    { id: 101, brand: 'Levi\'s', title: 'Men Slim Fit Dark Wash Jeans', price: 1445, originalPrice: 2999, discount: '51%', image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 102, brand: 'Wrangler', title: 'Men Regular Fit Blue Jeans', price: 1299, originalPrice: 2599, discount: '50%', image: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false },
  ];
