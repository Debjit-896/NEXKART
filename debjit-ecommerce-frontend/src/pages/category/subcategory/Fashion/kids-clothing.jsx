...
export default function KidsClothingPage() {
  ...
  const subcategoryDisplayName = "Kids' Clothing";
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['kids-clothing']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 401, brand: 'Lilliput', title: 'Boys Cotton Printed Tee & Shorts Set', price: 399, originalPrice: 999, discount: '60%', image: 'https://images.unsplash.com/photo-1519241047957-be31d7379a5d?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 402, brand: 'Nauti Nati', title: 'Girls Floral Print Party Dress', price: 699, originalPrice: 1599, discount: '56%', image: 'https://images.unsplash.com/photo-1519241047957-be31d7379a5d?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
