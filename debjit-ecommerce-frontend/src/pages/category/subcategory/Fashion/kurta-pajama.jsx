...
export default function KurtaPajamaPage() {
  const categoryDisplayName = 'Fashion';
  const subcategoryDisplayName = 'Kurta, pajama';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['kurta-pajama']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 801, brand: 'Manyavar', title: 'Men Cotton Blend Kurta Pajama Set', price: 1999, originalPrice: 3999, discount: '50%', image: 'https://images.unsplash.com/photo-1596455607563-ad6193f76b11?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 802, brand: 'Soch', title: 'Women Embroidered Kurta Suit Set', price: 1799, originalPrice: 3599, discount: '50%', image: 'https://images.unsplash.com/photo-1596455607563-ad6193f76b11?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
