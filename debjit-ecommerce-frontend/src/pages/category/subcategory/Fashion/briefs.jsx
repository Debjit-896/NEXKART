...
export default function BriefsPage() {
  ...
  const subcategoryDisplayName = 'Briefs';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['briefs']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 901, brand: 'Jockey', title: 'Men Cotton Briefs Pack of 3', price: 499, originalPrice: 899, discount: '44%', image: 'https://images.unsplash.com/photo-1616150854483-294025a1f649?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 902, brand: 'Amul Macho', title: 'Men Cotton Trunks Pack of 2', price: 249, originalPrice: 499, discount: '50%', image: 'https://images.unsplash.com/photo-1616150854483-294025a1f649?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
