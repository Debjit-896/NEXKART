...
export default function WatchesPage() {
  ...
  const subcategoryDisplayName = 'Watches';
  
  const currentConfig = filterConfig['fashion'].subcategories['watches'];
  ...
  // Mock Products
  const products = [
    { id: 101, brand: 'Titan', title: 'Men Analog Watch', price: 2999, originalPrice: 3999, discount: '25%', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 102, brand: 'Fossil', title: 'Chronograph Leather Watch', price: 6999, originalPrice: 9999, discount: '30%', image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false },
  ];
