...
export default function SportsShoesPage() {
  const categoryDisplayName = 'Fashion';
  const subcategoryDisplayName = 'Sports Shoes';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['sports-shoes']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 301, brand: 'PUMA', title: 'Men Blue Sports Shoes', price: 1499, originalPrice: 2999, discount: '50%', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 302, brand: 'Nike', title: 'Air Max Men Running Shoes', price: 4495, originalPrice: 7999, discount: '43%', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
