...
export default function ShirtsTeesPage() {
  const categoryDisplayName = 'Fashion';
  const subcategoryDisplayName = 'Shirts & Tees';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['shirts-tees']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 201, brand: 'TRIPR', title: 'Pack of 4 Men Solid T-Shirt', price: 445, originalPrice: 1999, discount: '77%', image: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 202, brand: 'Try This', title: 'Men Typography Print T-Shirt', price: 299, originalPrice: 999, discount: '70%', image: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 203, brand: 'ParcelYard', title: 'Men Regular Fit Self T-Shirt', price: 464, originalPrice: 1999, discount: '76%', image: 'https://images.unsplash.com/photo-1596755094514-f87e32f85e23?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false },
    { id: 204, brand: 'METRONAUT', title: 'Men Regular Fit Solid Shirt', price: 289, originalPrice: 1399, discount: '79%', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&w=300&q=80', assured: false, sponsored: false }
  ];
