...
export default function TrackpantsPage() {
  ...
  const subcategoryDisplayName = 'Trackpants';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['trackpants']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 601, brand: 'Puma', title: 'Men Regular Fit Trackpants', price: 999, originalPrice: 1999, discount: '50%', image: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 602, brand: 'Fort Collins', title: 'Men Solid Trackpants', price: 499, originalPrice: 1299, discount: '61%', image: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
