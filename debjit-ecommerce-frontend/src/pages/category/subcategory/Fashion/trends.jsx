...
export default function TrendsPage() {
  ...
  const subcategoryDisplayName = 'Trends';
  
  const currentConfig = filterConfig['fashion'].subcategories['trends'];
  ...
  // Mock Products
  const products = [
    { id: 101, brand: 'Zara', title: 'Y2K Oversized Cargo Pants', price: 2999, originalPrice: 4999, discount: '40%', image: 'https://images.unsplash.com/photo-1542272454315-4c01d7abdf4a?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 102, brand: 'H&M', title: 'Minimalist Earth Tone Tee', price: 999, originalPrice: 1999, discount: '50%', image: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false },
  ];
