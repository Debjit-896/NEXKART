...
export default function LuggagePage() {
  ...
  const subcategoryDisplayName = 'Luggage';
  
  const currentConfig = (filterConfig['fashion'].subcategories && filterConfig['fashion'].subcategories['luggage']) || filterConfig['fashion'];
  ...
  const products = [
    { id: 501, brand: 'Safari', title: '4 Wheel Hard Cabin Trolley Bag', price: 1899, originalPrice: 4999, discount: '62%', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: true },
    { id: 502, brand: 'Skybags', title: 'Polyester Medium Suitcase Trolley Bag', price: 2499, originalPrice: 5999, discount: '58%', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=300&q=80', assured: true, sponsored: false }
  ];
